...
| **Placing** | Wall, Cube, Pillar, Landmine, Fan, Hole, Ping-pong ball (light), Cannon ball (heavy), Roller (rolls along its axis only): range ring, ghost, Q/E or wheel to turn, click to place. |
