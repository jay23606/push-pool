...
export function bindGameInput(game){
 ...
 const h=game.handlers={
  ...
  up:e=>{if(game.placing?.toss){if(game.placing.drag){game.movePlacing(game.point(e));game.placing.drag=false;game.confirmPlace()}game.surface.releasePointerCapture?.(e.pointerId);return}h.move(e);game.drag=false;game.surface.releasePointerCapture?.(e.pointerId)},
