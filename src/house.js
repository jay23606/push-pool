...
//   oneShot      P.U.S.H. modes: a turn is a single shot, even when you sink a ball
//   cannon       P.U.S.H. modes: every player starts each rack holding a cannon (break with it, if you like)
//
...
export const DEFAULT_HOUSE={race:3,ballInHand:'anywhere',breaker:'host',straightTo:30,jumps:false,cannon:false,oneShot:false}
...
export function describe(h){
 ...
 if(n.cannon)parts.push('everyone starts with a cannon')
 if(n.oneShot)parts.push('one shot per turn')
 return parts.join(' · ')
}
