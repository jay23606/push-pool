...
function openHouse(){
 ...
 $('#house-jumps').checked=h.jumps;$('#house-cannon').checked=h.cannon
 $('#house-summary').textContent=houseIsDefault(h)?'Standard rules.':describeHouse(h)
 $('#house-dialog').showModal()
}
function saveHouse(){
 const h=normalizeHouse({race:Number($('#house-race').value),ballInHand:$('#house-bih').value,breaker:$('#house-breaker').value,straightTo:Number($('#house-straight').value),jumps:$('#house-jumps').checked,cannon:$('#house-cannon').checked})
