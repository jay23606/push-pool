...
async function startHotSeat(mode=chosenMode(),party=null){
 ...
 $('#versus').innerHTML=party?`<span style="grid-column:1/-1;text-align:center"><b>${party.seats.length} players${party.teams?' in two teams':''}</b><small>Pass the device</small></span>`:'<span><b>Player 1</b><small>Break</small></span><i>vs</i><span><b>Player 2</b><small>Pass the device</small></span>'
